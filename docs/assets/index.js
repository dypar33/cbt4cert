(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const s of o.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&r(s)}).observe(document,{childList:!0,subtree:!0});function t(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(n){if(n.ep)return;n.ep=!0;const o=t(n);fetch(n.href,o)}})();async function q(){try{const e=window.location.hostname==="dypar33.github.io"?"/cbt4cert":"/docs",t=await fetch(`${e}/data/index.json`);if(!t.ok)throw new Error(`카탈로그 로드 실패: ${t.status}`);const r=await t.json();return T(r),r}catch(i){throw console.error("카탈로그 로드 중 오류:",i),new Error("카탈로그를 불러올 수 없습니다.")}}async function E(i,e,t=null){try{const n=window.location.hostname==="dypar33.github.io"?"/cbt4cert":"/docs";if(typeof e=="string"){const o=`${n}/data/${encodeURIComponent(i)}/${encodeURIComponent(e)}/questions.json`,s=await fetch(o);if(!s.ok)throw new Error(`문제 은행 로드 실패: ${s.status}`);const a=await s.json();if(!Array.isArray(a))throw new Error("문제 데이터가 배열 형태가 아닙니다.");return a.map(k)}if(e&&e.chapters){const o=e.name;let s=t||e.chapters.map(l=>l.file);const a=[];for(const l of s)try{const c=`${n}/data/${encodeURIComponent(i)}/${encodeURIComponent(o)}/${encodeURIComponent(l)}`,u=await fetch(c);if(!u.ok){console.warn(`챕터 파일 로드 실패: ${l} (${u.status})`);continue}const d=await u.json();Array.isArray(d)&&a.push(...d)}catch(c){console.warn(`챕터 파일 로드 중 오류: ${l}`,c)}if(a.length===0)throw new Error("선택된 챕터에서 문제를 불러올 수 없습니다.");return a.map(k)}throw new Error("올바르지 않은 과목 데이터입니다.")}catch(r){throw console.error("문제 은행 로드 중 오류:",r),new Error(`${i} - ${typeof e=="string"?e:e.name} 문제를 불러올 수 없습니다.`)}}function T(i){if(!i||typeof i!="object")throw new Error("카탈로그 형식이 올바르지 않습니다.");if(!Array.isArray(i.certifications))throw new Error("자격증 목록이 배열 형태가 아닙니다.");for(const e of i.certifications){if(!e.name||typeof e.name!="string")throw new Error("자격증 이름이 올바르지 않습니다.");if(!Array.isArray(e.subjects))throw new Error("과목 목록이 배열 형태가 아닙니다.")}}function k(i){if(!i||typeof i!="object")throw new Error("문제 데이터가 객체 형태가 아닙니다.");if(!i.id||typeof i.id!="string")throw new Error("문제 ID가 올바르지 않습니다.");if(!i.question||typeof i.question!="string")throw new Error("문제 내용이 올바르지 않습니다.");if(!Array.isArray(i.answer))throw new Error("정답이 배열 형태가 아닙니다.");const e=i.choices&&Array.isArray(i.choices)?"mcq":"short";return{id:i.id,question:i.question,description:i.description||void 0,type:i.type||e,choices:i.choices||void 0,answer:i.answer,explanation:i.explanation||void 0,tags:i.tags||void 0}}const w=Object.freeze(Object.defineProperty({__proto__:null,loadCatalog:q,loadQuestionBank:E},Symbol.toStringTag,{value:"Module"}));function L(i,e,t){if(i.length===0)throw new Error("문제 은행이 비어있습니다.");if(t<=0)throw new Error("문제 개수는 1개 이상이어야 합니다.");const r=i.map(n=>n.id);switch(e){case"sequential":return r.slice(0,Math.min(t,r.length));case"random":return $(r).slice(0,Math.min(t,r.length));case"randomRepeat":const n=$(r),o=[];for(let s=0;s<t;s++)o.push(n[s%n.length]);return o;default:throw new Error(`지원하지 않는 출제 순서: ${e}`)}}function M(i,e){return{id:N(),config:i,questionIds:e,currentIndex:0,answers:{},startTime:Date.now()}}function j(i,e,t,r){const n={...i,answers:{...i.answers,[e]:t}};if(i.config.mode==="practice"&&r){const o=P(t,r);return{run:n,feedback:o}}return{run:n}}function H(i,e){const t=Date.now(),r=new Map(e.map(c=>[c.id,c]));let n=0;const o=[];for(const c of i.questionIds){const u=i.config.order==="randomRepeat"?c.split("_")[0]:c,d=r.get(u),h=i.answers[c]||[];d&&z(h,d)?n++:o.push(c)}const s=i.config.order==="randomRepeat"?i.config.count:i.questionIds.length,a=s>0?Math.round(n/s*100):0,l=t-i.startTime;return{score:a,total:s,correct:n,wrong:o,timeSpent:l}}function P(i,e){return{correct:z(i,e),expected:e.answer,explanation:e.explanation}}function z(i,e){const t=o=>o.trim().toLowerCase().replace(/\s+/g,""),r=i.map(t).sort(),n=e.answer.map(t).sort();return r.length!==n.length?!1:r.every((o,s)=>o===n[s])}function $(i){const e=[...i];for(let t=e.length-1;t>0;t--){const r=Math.floor(Math.random()*(t+1));[e[t],e[r]]=[e[r],e[t]]}return e}function N(){return`run_${Date.now()}_${Math.random().toString(36).substr(2,9)}`}const F="modulepreload",O=function(i){return"/cbt4cert/"+i},I={},x=function(e,t,r){let n=Promise.resolve();if(t&&t.length>0){document.getElementsByTagName("link");const s=document.querySelector("meta[property=csp-nonce]"),a=(s==null?void 0:s.nonce)||(s==null?void 0:s.getAttribute("nonce"));n=Promise.allSettled(t.map(l=>{if(l=O(l),l in I)return;I[l]=!0;const c=l.endsWith(".css"),u=c?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${u}`))return;const d=document.createElement("link");if(d.rel=c?"stylesheet":F,c||(d.as="script"),d.crossOrigin="",d.href=l,a&&d.setAttribute("nonce",a),document.head.appendChild(d),c)return new Promise((h,p)=>{d.addEventListener("load",h),d.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${l}`)))})}))}function o(s){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=s,window.dispatchEvent(a),!a.defaultPrevented)throw s}return n.then(s=>{for(const a of s||[])a.status==="rejected"&&o(a.reason);return e().catch(o)})},Q="cbt4cert",S={darkMode:!1};function m(){try{const i=localStorage.getItem(Q);if(!i)return{preferences:S};const e=JSON.parse(i);return{preferences:{...S,...e.preferences},currentRun:e.currentRun}}catch(i){return console.warn("저장된 데이터 로드 실패, 기본값 사용:",i),{preferences:S}}}function b(i){try{localStorage.setItem(Q,JSON.stringify(i))}catch(e){console.error("데이터 저장 실패:",e)}}function R(i){const e=m();e.preferences={...e.preferences,...i},b(e)}function _(){const e=!m().preferences.darkMode;return R({darkMode:e}),document.documentElement.setAttribute("data-theme",e?"dark":"light"),e}function D(){const i=m();document.documentElement.setAttribute("data-theme",i.preferences.darkMode?"dark":"light")}const B="data:image/svg+xml,%3csvg%20xmlns='http://www.w3.org/2000/svg'%20viewBox='0%200%2036%2036'%3e%3cpath%20fill='%23F18F26'%20d='M10.478%2022.439s.702%202.281-.337%207.993c-.186%201.025-.46%202.072-.599%202.93-1.757%200-1.851%202.002-1.478%202.002h2.094c1.337%200%202.971-3.334%203.854-7.961s-3.534-4.964-3.534-4.964zm13.042%203.702s2.272%201.22%202.188%204.081c-.033%201.131-.249%202.091-.355%203.024-1.832%200-1.839%201.985-1.305%201.985h1.856c.923%200%203.001-3.158%203.379-7.281.379-4.122-5.763-1.809-5.763-1.809z'/%3e%3cpath%20fill='%23
%200-.114-2.286-1.099-2.527%200%200-.732%201.372-1.1%203.814z'%20fill='%237F676D'/%3e%3cpath%20fill='%2366757F'%20d='M18.45%2023.644c-2.649.57-2.38%202.782-2.38%202.782s1.93.505%206.038-.208c1.067-.185%202.153-.03%203.107.377-1.607-3.047-4.315-3.479-6.765-2.951z'/%3e%3cpath%20fill='%23292F33'%20d='M5.976%2010.982s.333.347.319.778c-.014.43-.25.833-.25.833s-.292-.347-.319-.826c-.027-.48.25-.785.25-.785z'/%3e%3c/svg%3e",A={cuteCat:B,blackCat:U};class J{constructor(e){this.container=e,this.catalog=null,this.onStartQuiz=null}render(e,t){this.catalog=e,this.onStartQuiz=t;const n=m().preferences;this.container.innerHTML=`
    ...
    `,this.attachEventListeners(),this.setupImages()}setupImages(){const e=this.container.querySelector(".cute-cat-icon");e&&(e.style.backgroundImage=`url(${A.cuteCat})`)}attachEventListeners(){const e=this.container.querySelector("#theme-toggle");e.addEventListener("click",()=>{const a=_();e.textContent=a?"☀️ 라이트 모드":"🌙 다크 모드"});const t=this.container.querySelector("#certification"),r=this.container.querySelector("#subject"),n=this.container.querySelector("#order");this.container.querySelector("#count");const o=async()=>{const a=t.value,l=r.value,c=n.value,u=this.container.querySelector("#question-count-info"),d=this.container.querySelector("#count-input-container"),h=this.container.querySelector("#count");if(a&&l)try{const{loadQuestionBank:p}=await x(async()=>{const{loadQuestionBank:y}=await Promise.resolve().then(()=>w);return{loadQuestionBank:y}},void 0),f=(await p(a,l)).length;f>0?c==="randomRepeat"?(u.innerHTML=`
              ...
              `,d.style.display="block",h.max=Math.max(100,f),h.placeholder=`1-${Math.max(100,f)}개`):(u.innerHTML=`
    ...
    `).join(""),n.checked=!0,n.addEventListener("change",()=>{r.querySelectorAll(".chapter-checkbox").forEach(a=>{a.checked=n.checked}),this.updateQuestionCountForChapters()});const o=r.querySelectorAll(".chapter-checkbox");o.forEach(s=>{s.addEventListener("change",()=>{const a=Array.from(o).every(c=>c.checked),l=Array.from(o).every(c=>!c.checked);n.checked=a,n.indeterminate=!a&&!l,this.updateQuestionCountForChapters()})}),t.style.display="block",this.updateQuestionCountForChapters()}hideChapterSelection(){const e=this.container.querySelector("#chapter-selection");e.style.display="none"}async updateQuestionCountForChapters(){const e=this.container.querySelector("#certification").value,t=this.container.querySelector("#subject"),r=this.container.querySelector("#order").value,n=this.container.querySelector("#question-count-info"),o=this.container.querySelector("#count-input-container"),s=this.container.querySelector("#count");if(!(!e||!t.value))try{const a=JSON.parse(t.value.replace(/&quot;/g,'"'));if(!a.chapters)return;const l=Array.from(this.container.querySelectorAll(".chapter-checkbox:checked")).map(h=>h.value);if(l.length===0){n.innerHTML=`
        ...
        `,o.style.display="none";return}const{loadQuestionBank:c}=await x(async()=>{const{loadQuestionBank:h}=await Promise.resolve().then(()=>w);return{loadQuestionBank:h}},void 0),d=(await c(e,a,l)).length;if(d>0){const h=l.map(p=>{const v=a.chapters.find(f=>f.file===p);return v?v.name:p}).join(", ");r==="randomRepeat"?(n.innerHTML=`
          ...
          `,o.style.display="block",s.max=Math.max(100,d),s.placeholder=`1-${Math.max(100,d)}개`):(n.innerHTML=`
        ...
        <span style="color: var(--color-error);">문제를 불러올 수 없습니다</span>
      `,o.style.display="none"}}getSelectedChapters(){const e=this.container.querySelectorAll(".chapter-checkbox:checked");return Array.from(e).map(t=>t.value)}}class K{constructor(e){this.container=e}formatText(e){return e?e.replace(/\\n/g,`
`).replace(/\n/g,"<br>").replace(/\s{2,}/g," "):""}render(e,t,r,n,o){const s=e.wrong.map(c=>{const u=r.config.order==="randomRepeat"?c.split("_")[0]:c;return t.find(d=>d.id===u)}).filter(Boolean),a=Math.floor(e.timeSpent/6e4),l=Math.floor(e.timeSpent%6e4/1e3);this.container.innerHTML=`
    ...
    `,this.attachEventListeners(n,o)}attachEventListeners(e,t){const r=this.container.querySelector("#retry-btn"),n=this.container.querySelector("#home-btn");r.addEventListener("click",e),n.addEventListener("click",t)}}function G(i){if(!i)return"";const e=document.createElement("div");return e.textContent=i,e.innerHTML}class V{constructor(e){this.container=e,this.questions=[],this.run=null,this.currentIndex=0,this.onComplete=null,this.feedbackShown=new Set,this.boundHandleKeydown=this.handleKeydown.bind(this),this.randomQuestionHistory=[],this.totalQuestionsAnswered=0}formatText(e,t=null){if(!e)return"";let r=G(e).replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;");return r=r.replace(/\[img:(\d+)\]/g,(n,o)=>{var p,v,f,y,C;const s=(v=(p=this.run)==null?void 0:p.config)==null?void 0:v.certification,a=(y=(f=this.run)==null?void 0:f.config)==null?void 0:y.subject,l=typeof a=="object"?a==null?void 0:a.name:a,u=`${t||((C=this.getCurrentQuestion())==null?void 0:C.id)||"unknown"}-${o}.png`,d=window.location.hostname==="localhost"||window.location.hostname==="127.0.0.1";let h;return s&&l?d?h=`docs/data/${s}/${l}/images/${u}`:h=`data/${s}/${l}/images/${u}`:d?h=`docs/data/images/${u}`:h=`data/images/${u}`,`
        <img 
          src="${h}" 
          alt="문제 이미지" 
          style="
      ...
      `}),r}render(e,t,r){this.questions=e,this.run=t,this.onComplete=r,this.currentIndex=0,this.feedbackShown.clear(),this.randomQuestionHistory=[],this.totalQuestionsAnswered=0,this.run.config.order==="randomRepeat"&&this.selectRandomQuestion(),this.restoreProgress(),this.renderQuestion(),this.attachEventListeners()}setupImages(){const e=this.container.querySelector(".black-cat-icon");e&&(e.style.backgroundImage=`url(${A.blackCat})`)}renderAnswerInput(e,t){var r,n;if(e.type==="short"||!e.choices)return`
        <input 
          type="text" 
          class="input" 
          id="short-answer"
        ...
        />
      `;{const o=e.answer.length>1,s=o?"checkbox":"radio",a=o?"":"mcq-answer";let l=[...e.choices];if((n=(r=this.run)==null?void 0:r.config)!=null&&n.shuffleChoices){const c=this.run.config.order==="randomRepeat"?this.run.questionIds[this.currentIndex]:e.id;l=this.shuffleArray(l,c)}return`
        <div style="display: flex; flex-direction: column; gap: var(--space-3);">
          ${l.map((c,u)=>{var f;const d=t.includes(c),h=`choice-${u}`,p=this.cleanChoiceText(c),v=u+1;return`
              <label 
                for="${h}"
                style="
                  display: flex; 
              ...
              >
                ...
                <span style="flex: 1; font-size: var(--font-size-base);">
                  <span style="font-weight: 500; margin-right: var(--space-2);">${v}.</span>
                  ${this.formatText(p,(f=this.getCurrentQuestion())==null?void 0:f.id)}
                </span>
              </label>
            `}).join("")}
        </div>
...
정말로 종료하시겠습니까?`:"정말로 퀴즈를 종료하시겠습니까?";confirm(r)&&(this.saveProgress(),(n=this.onComplete)==null||n.call(this))}handleKeydown(e){if(!e.repeat){if(e.key>="1"&&e.key<="9"){const t=parseInt(e.key)-1,r=this.container.querySelector(`#choice-${t}`);r&&r.click()}if(e.key==="Enter"&&!(document.activeElement.tagName==="INPUT"&&document.activeElement.type==="text")){e.preventDefault();const t=this.container.querySelector("#next-btn"),r=this.container.querySelector("#finish-btn");t&&!t.disabled?t.click():r&&r.click()}e.key==="ArrowLeft"?this.goToPrevious():e.key==="ArrowRight"&&this.goToNext()}}getCurrentQuestion(){if(!this.run)return;const e=this.run.questionIds[this.currentIndex],t=this.run.config.order==="randomRepeat"?e.split("_")[0]:e;return this.questions.find(r=>r.id===t)}checkAnswer(e,t){const r=s=>this.cleanChoiceText(s).toLowerCase().trim().replace(/\s+/g," "),n=e.answer.map(r),o=t.map(r);return n.length===o.length&&n.every(s=>o.includes(s))}saveProgress(){if(!this.run)return;const e=m();e.currentRun=this.run,e.currentIndex=this.currentIndex,b(e)}restoreProgress(){const e=m();e.currentIndex!==void 0&&(this.currentIndex=Math.max(0,Math.min(e.currentIndex,this.run.questionIds.length-1)))}setAutoFocus(){const e=this.getCurrentQuestion();e&&(e.type==="short"||!e.choices)&&setTimeout(()=>{const t=this.container.querySelector("#short-answer");t&&(t.focus(),t.setSelectionRange(t.value.length,t.value.length))},100)}selectRandomQuestion(){if(!this.run||this.run.config.order!=="randomRepeat")return;const e=this.questions.map(s=>s.id);let t,r=0;const n=50;do{const s=Math.floor(Math.random()*e.length);t=e[s],r++}while(r<n&&this.randomQuestionHistory.length>0&&t===this.randomQuestionHistory[this.randomQuestionHistory.length-1].split("_")[0]);const o=`${t}_${this.randomQuestionHistory.length}`;this.randomQuestionHistory.push(o),this.run.questionIds=[...this.randomQuestionHistory],this.currentIndex=this.randomQuestionHistory.length-1}renderQuestion(){if(!this.run||!this.questions.length)return;const e=this.getCurrentQuestion();if(!e)return;let t,r;if(this.run.config.order==="randomRepeat"){const c=Math.min(this.totalQuestionsAnswered+1,this.run.config.count);t=this.totalQuestionsAnswered/this.run.config.count*100,r=`${c} / ${this.run.config.count}`}else t=(this.currentIndex+1)/this.run.questionIds.length*100,r=`${this.currentIndex+1} / ${this.run.questionIds.length}`;const n=this.run.config.order==="randomRepeat"?this.run.questionIds[this.currentIndex]:e.id,o=this.shouldClearAnswer(e)?[]:this.run.answers[n]||[],s=o.length>0,a=this.run.config.mode==="practice"&&this.feedbackShown.has(this.currentIndex),l=a&&s?this.checkAnswer(e,o):!1;this.container.innerHTML=`
    ...
    `,this.attachNavigationEvents(),this.attachAnswerEvents(),this.setupImages(),this.setAutoFocus()}shouldClearAnswer(e){return this.run.config.order!=="randomRepeat",!1}shouldDisablePrevButton(){return this.run.config.order==="randomRepeat"?this.randomQuestionHistory.length<=1:this.currentIndex===0}shouldShowFinishButton(){return this.run.config.order==="randomRepeat"?this.totalQuestionsAnswered>=this.run.config.count:this.currentIndex===this.run.questionIds.length-1}shuffleArray(e,t){const r=String(t||"default");let n=0;for(let s=0;s<r.length;s++)n+=r.charCodeAt(s);const o=[...e];for(let s=o.length-1;s>0;s--){n=(n*9301+49297)%233280;const a=Math.floor(n/233280*(s+1));[o[s],o[a]]=[o[a],o[s]]}return o}cleanChoiceText(e){return e?e.replace(/^\s*\d+\.\s*/,"").trim():""}getFormattedCorrectAnswers(e){var n,o;if(e.type==="short"||!e.choices)return e.answer.map(s=>this.formatText(s,e.id)).join(", ");let t=[...e.choices];if((o=(n=this.run)==null?void 0:n.config)!=null&&o.shuffleChoices){const s=this.run.config.order==="randomRepeat"?this.run.questionIds[this.currentIndex]:e.id;t=this.shuffleArray(t,s)}return e.answer.map(s=>{const a=t.findIndex(l=>{const c=this.cleanChoiceText(l),u=this.cleanChoiceText(s);return c.toLowerCase().trim()===u.toLowerCase().trim()});if(a!==-1){const l=a+1,c=this.cleanChoiceText(s);return`${l}. ${this.formatText(c,e.id)}`}else{const l=this.cleanChoiceText(s);return this.formatText(l,e.id)}}).join(", ")}destroy(){document.removeEventListener("keydown",this.boundHandleKeydown)}}class W{constructor(){this.listeners=[],window.addEventListener("hashchange",()=>{this.notifyListeners()}),window.addEventListener("load",()=>{this.notifyListeners()})}getCurrentRoute(){const e=window.location.hash.slice(1);if(!e)return{path:"/",params:{}};const[t,r]=e.split("?"),n={};if(r){const o=new URLSearchParams(r);for(const[s,a]of o)n[s]=decodeURIComponent(a)}return{path:t||"/",params:n}}onRouteChange(e){this.listeners.push(e)}navigate(e,t){let r=`#${e}`;if(t&&Object.keys(t).length>0){const n=new URLSearchParams;for(const[o,s]of Object.entries(t))n.set(o,encodeURIComponent(s));r+=`?${n.toString()}`}window.location.hash=r}navigateToQuiz(e){const t=new URLSearchParams({certification:e.certification,subject:typeof e.subject=="string"?e.subject:JSON.stringify(e.subject),order:e.order,mode:e.mode,count:e.count.toString()});e.selectedChapters&&e.selectedChapters.length>0&&t.set("chapters",JSON.stringify(e.selectedChapters)),e.shuffleChoices&&t.set("shuffleChoices","true"),this.navigate(`/quiz?${t.toString()}`)}navigateToResults(){this.navigate("/results")}navigateToHome(){this.navigate("/")}parseQuizConfig(e){const{certification:t,subject:r,order:n,mode:o,count:s,chapters:a,shuffleChoices:l}=e;if(!t||!r||!n||!o||!s)return null;const c=parseInt(s);if(isNaN(c)||c<1||c>100||!["sequential","random","randomRepeat"].includes(n)||!["practice","exam"].includes(o))return null;let u;try{u=JSON.parse(r)}catch{u=r}let d=null;if(a)try{d=JSON.parse(a),Array.isArray(d)||(d=null)}catch(p){console.warn("챕터 파라미터 파싱 실패:",p),d=null}return{certification:t,subject:u,selectedChapters:d,order:n,mode:o,count:c,shuffleChoices:l==="true"}}notifyListeners(){const e=this.getCurrentRoute();console.log("라우트 변경:",e),this.listeners.forEach(t=>t(e))}}const g=new W;class Y{constructor(e){this.container=e,this.catalog=null,this.currentRun=null,this.currentQuestions=[],this.home=new J(e),this.results=new K(e),this.runner=new V(e),g.onRouteChange(t=>this.handleRouteChange(t))}async initialize(){try{console.log("앱 초기화 중..."),this.catalog=await q(),console.log("카탈로그 로드 완료"),this.restoreState(),this.handleRouteChange(g.getCurrentRoute())}catch(e){console.error("앱 초기화 실패:",e),this.showError("앱을 시작할 수 없습니다",e)}}async handleRouteChange(e){console.log("라우트 변경:",e);try{switch(e.path){case"/":this.showHome();break;case"/quiz":await this.showQuiz(e.params);break;case"/results":this.showResults();break;default:console.warn("알 수 없는 라우트:",e.path),g.navigateToHome()}}catch(t){console.error("라우트 처리 실패:",t),this.showError("페이지를 로드할 수 없습니다",t)}}showHome(){if(!this.catalog){this.showError("카탈로그가 로드되지 않았습니다");return}this.home.render(this.catalog,e=>{g.navigateToQuiz(e)})}async showQuiz(e){const t=g.parseQuizConfig(e);if(!t){console.error("잘못된 퀴즈 설정:",e),g.navigateToHome();return}try{console.log("문제 은행 로딩 중...",t.certification,t.subject);const r=await E(t.certification,t.subject,t.selectedChapters);if(r.length===0)throw new Error("문제가 없습니다");const n=L(r,t.order,t.count);this.currentRun=M(t,n),this.currentQuestions=r,this.saveState(),console.log(`퀴즈 시작: ${n.length}개 문제`),this.runner.render(this.currentQuestions,this.currentRun,()=>{this.restoreState(),g.navigateToResults()})}catch(r){console.error("퀴즈 시작 실패:",r),this.showError("퀴즈를 시작할 수 없습니다",r)}}showResults(){if(!this.currentRun||!this.currentQuestions.length){console.warn("표시할 결과가 없습니다"),g.navigateToHome();return}const e=H(this.currentRun,this.currentQuestions);this.showResultsWithData(e)}showResultsWithData(e){this.currentRun&&this.results.render(e,this.currentQuestions,this.currentRun,()=>{this.currentRun&&g.navigateToQuiz(this.currentRun.config)},()=>{this.clearState(),g.navigateToHome()})}showError(e,t){const r=t instanceof Error?t.message:"알 수 없는 오류";this.container.innerHTML=`
    ...
    `;const n=this.container.querySelector("#home-btn");n==null||n.addEventListener("click",()=>{this.clearState(),g.navigateToHome()})}saveState(){const e=m();e.currentRun=this.currentRun||void 0,b(e)}restoreState(){const e=m();e.currentRun&&(this.currentRun=e.currentRun,console.log("저장된 퀴즈 상태 복원됨"))}clearState(){this.currentRun=null,this.currentQuestions=[];const e=m();delete e.currentRun,b(e)}}console.log("CBT4Cert 앱이 시작되었습니다.");D();const X=document.querySelector("#app"),Z=new Y(X);Z.initialize();
