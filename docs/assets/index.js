(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const o of n)if(o.type==="childList")for(const i of o.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function t(n){const o={};return n.integrity&&(o.integrity=n.integrity),n.referrerPolicy&&(o.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?o.credentials="include":n.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function r(n){if(n.ep)return;n.ep=!0;const o=t(n);fetch(n.href,o)}})();async function $(){try{const e=window.location.hostname==="dypar33.github.io"?"/cbt4cert":"",t=await fetch(`${e}/data/index.json`);if(!t.ok)throw new Error(`카탈로그 로드 실패: ${t.status}`);const r=await t.json();return S(r),r}catch(s){throw console.error("카탈로그 로드 중 오류:",s),new Error("카탈로그를 불러올 수 없습니다.")}}async function k(s,e){try{const n=`${window.location.hostname==="dypar33.github.io"?"/cbt4cert":""}/data/${encodeURIComponent(s)}/${encodeURIComponent(e)}/questions.json`,o=await fetch(n);if(!o.ok)throw new Error(`문제 은행 로드 실패: ${o.status}`);const i=await o.json();if(!Array.isArray(i))throw new Error("문제 데이터가 배열 형태가 아닙니다.");return i.map(E)}catch(t){throw console.error("문제 은행 로드 중 오류:",t),new Error(`${s} - ${e} 문제를 불러올 수 없습니다.`)}}function S(s){if(!s||typeof s!="object")throw new Error("카탈로그 형식이 올바르지 않습니다.");if(!Array.isArray(s.certifications))throw new Error("자격증 목록이 배열 형태가 아닙니다.");for(const e of s.certifications){if(!e.name||typeof e.name!="string")throw new Error("자격증 이름이 올바르지 않습니다.");if(!Array.isArray(e.subjects))throw new Error("과목 목록이 배열 형태가 아닙니다.")}}function E(s){if(!s||typeof s!="object")throw new Error("문제 데이터가 객체 형태가 아닙니다.");if(!s.id||typeof s.id!="string")throw new Error("문제 ID가 올바르지 않습니다.");if(!s.question||typeof s.question!="string")throw new Error("문제 내용이 올바르지 않습니다.");if(!Array.isArray(s.answer))throw new Error("정답이 배열 형태가 아닙니다.");const e=s.choices&&Array.isArray(s.choices)?"mcq":"short";return{id:s.id,question:s.question,description:s.description||void 0,type:s.type||e,choices:s.choices||void 0,answer:s.answer,explanation:s.explanation||void 0,tags:s.tags||void 0}}function I(s,e,t){if(s.length===0)throw new Error("문제 은행이 비어있습니다.");if(t<=0)throw new Error("문제 개수는 1개 이상이어야 합니다.");const r=s.map(n=>n.id);switch(e){case"sequential":return r.slice(0,Math.min(t,r.length));case"random":return m(r).slice(0,Math.min(t,r.length));case"randomRepeat":const n=m(r),o=[];for(let i=0;i<t;i++)o.push(n[i%n.length]);return o;default:throw new Error(`지원하지 않는 출제 순서: ${e}`)}}function C(s,e){return{id:A(),config:s,questionIds:e,currentIndex:0,answers:{},startTime:Date.now()}}function z(s,e,t,r){const n={...s,answers:{...s.answers,[e]:t}};if(s.config.mode==="practice"&&r){const o=q(t,r);return{run:n,feedback:o}}return{run:n}}function R(s,e){const t=Date.now(),r=new Map(e.map(c=>[c.id,c]));let n=0;const o=[];for(const c of s.questionIds){const u=r.get(c),p=s.answers[c]||[];u&&b(p,u)?n++:o.push(c)}const i=s.questionIds.length,a=i>0?Math.round(n/i*100):0,l=t-s.startTime;return{score:a,total:i,correct:n,wrong:o,timeSpent:l}}function q(s,e){return{correct:b(s,e),expected:e.answer,explanation:e.explanation}}function b(s,e){const t=o=>o.trim().toLowerCase().replace(/\s+/g,""),r=s.map(t).sort(),n=e.answer.map(t).sort();return r.length!==n.length?!1:r.every((o,i)=>o===n[i])}function m(s){const e=[...s];for(let t=e.length-1;t>0;t--){const r=Math.floor(Math.random()*(t+1));[e[t],e[r]]=[e[r],e[t]]}return e}function A(){return`run_${Date.now()}_${Math.random().toString(36).substr(2,9)}`}const y="cbt4cert",f={darkMode:!1};function h(){try{const s=localStorage.getItem(y);if(!s)return{preferences:f};const e=JSON.parse(s);return{preferences:{...f,...e.preferences},currentRun:e.currentRun}}catch(s){return console.warn("저장된 데이터 로드 실패, 기본값 사용:",s),{preferences:f}}}function g(s){try{localStorage.setItem(y,JSON.stringify(s))}catch(e){console.error("데이터 저장 실패:",e)}}function w(s){const e=h();e.preferences={...e.preferences,...s},g(e)}function L(){const e=!h().preferences.darkMode;return w({darkMode:e}),document.documentElement.setAttribute("data-theme",e?"dark":"light"),e}function Q(){const s=h();document.documentElement.setAttribute("data-theme",s.preferences.darkMode?"dark":"light")}const x={cuteCat:"/assets/images/cute-cat.svg",blackCat:"/assets/images/black-cat.svg"};class T{constructor(e){this.container=e,this.catalog=null,this.onStartQuiz=null}render(e,t){this.catalog=e,this.onStartQuiz=t;const n=h().preferences;this.container.innerHTML=`
    ...
    `,this.attachEventListeners(n,o)}attachEventListeners(e,t){const r=this.container.querySelector("#retry-btn"),n=this.container.querySelector("#home-btn");r.addEventListener("click",e),n.addEventListener("click",t)}}function M(s){if(!s)return"";const e=document.createElement("div");return e.textContent=s,e.innerHTML}function v(s){return s?M(s).replace(/\n/g,"<br>").replace(/\t/g,"&nbsp;&nbsp;&nbsp;&nbsp;").replace(/  /g,"&nbsp;&nbsp;"):""}class P{constructor(e){this.container=e,this.questions=[],this.run=null,this.currentIndex=0,this.onComplete=null,this.feedbackShown=new Set}render(e,t,r){this.questions=e,this.run=t,this.onComplete=r,this.currentIndex=0,this.feedbackShown.clear(),this.restoreProgress(),this.renderQuestion(),this.attachEventListeners()}renderQuestion(){if(!this.run||!this.questions.length)return;const e=this.getCurrentQuestion();if(!e)return;const t=(this.currentIndex+1)/this.run.questionIds.length*100,r=this.run.answers[e.id]||[],n=r.length>0,o=this.run.config.mode==="practice"&&n&&this.feedbackShown.has(this.currentIndex),i=o?this.checkAnswer(e,r):!1;this.container.innerHTML=`
      <div class="container">
        <!-- 헤더 -->
        <header style="
          display: flex; 
